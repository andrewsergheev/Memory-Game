...
public class HighScoreTurns extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_high_score_turns);
        ...
        if (file.isDirectory()) {
            ...
            if (files != null && files.length > 0) {
                ArrayList<String> arrayList = highscore.getHighScoreTurnsArrayList();
